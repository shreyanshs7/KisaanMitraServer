...
from Inventory.views import upload_product, get_all_products, update_product, update_crop, get_all_crops, get_crops_by_user, delete_crop_user, farmer_dashboard
...
>>>>>>> b2dde3e2f7b15352cbd73a2c755c0c2475aef814
    path('', home, name = 'home'),
]
if settings.DEBUG:
